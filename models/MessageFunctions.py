...
class MessageFunction(nn.Module):
    ...
    def __init__(self, message_def='duvenaud', args={}):
        ...
        self.m_definition = '' # message function definition by str
        self.m_function = None # message function
        self.args = {}
        self.__set_message(message_def, args) # Initialization of message function
