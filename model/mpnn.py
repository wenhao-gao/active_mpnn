...
from feature.featurization import BatchMolGraph, get_atom_fdim, get_bond_fdim, mol2graph
...
class MPNEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.dropout = args.message_dropout
    ...
    def forward(self,
                ...
                duplicate: bool = False) -> torch.FloatTensor:
        """
...
class MessagePassingNetwork(nn.Module):
    ...
    def __init__(self, args: Namespace, device='cpu'):
        ...
        self.args = args
        self.args.output_size = args.output_dim
        self.device = device
